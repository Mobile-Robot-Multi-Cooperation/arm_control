...
set(_exported_dependencies "ocs2_core;ocs2_ddp;ocs2_mpc;ocs2_robotic_tools;ocs2_robotic_assets;ocs2_pinocchio_interface;ocs2_self_collision;ocs2_ros_interfaces;tf2;tf2_ros;Boost;angles;geometry_msgs;realtime_tools")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to ur5_interface_DEFINITIONS, ur5_interface_INCLUDE_DIRS,
# ur5_interface_LIBRARIES, and ur5_interface_LINK_FLAGS.
# Additionally collect the direct dependency names in
# ur5_interface_DEPENDENCIES as well as the recursive dependency names
# in ur5_interface_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(ur5_interface_DEPENDENCIES ${_exported_dependencies})
  set(ur5_interface_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(ur5_interface_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(ur5_interface_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(ur5_interface_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(ur5_interface_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(ur5_interface_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND ur5_interface_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
