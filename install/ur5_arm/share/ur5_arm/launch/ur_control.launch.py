...
def launch_setup(context, *args, **kwargs):
    ...
    pkg_share_path = get_package_share_directory("ur5_arm")
    ...
    # gazebo --------------------------------
    description_share = os.path.join(get_package_prefix("ur5_arm"), "meshes")
    gazebo_env_var = SetEnvironmentVariable(
    name='GAZEBO_MODEL_PATH',
    value=[
        os.environ.get('GAZEBO_MODEL_PATH', ''),
        '/root/ur5_pick_ws/src/ROS2_pick_and_place_UR5/ur5_arm/meshes'
    ]
)
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("ur5_arm"),
        "config",
        "ur_controllers.yaml",
    )
    ...
    ros2_control_node = Node(
        ...
        parameters=["/robot_description", ros2_controllers_path ,update_rate_config_file],
        output={
            "stdout": "screen",
            "stderr": "screen",
        }
