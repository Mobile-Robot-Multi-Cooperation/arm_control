...
def launch_setup(context, *args, **kwargs):
    ...
    ompl_planning_yaml = load_yaml("ur5_arm", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    controllers_yaml = load_yaml("ur5_arm", "config/moveit_controllers.yaml")
    ...
    # servo_yaml = load_yaml("ur5_arm", "config/ur_servo.yaml")
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "moveit_config_file",
            default_value="ur_macro.srdf.xacro",
