#include "ur5_interface/command/ur5_target_trajectories_interactive_marker.h"
...
UR5TargetTrajectoriesInteractiveMarker::createInteractiveMarker(int mode) const {
