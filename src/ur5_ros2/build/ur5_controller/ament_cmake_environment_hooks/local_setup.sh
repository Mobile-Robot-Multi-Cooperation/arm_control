...
: ${AMENT_CURRENT_PREFIX:="/root/ocs2_ros2/ros_ws/src/ur5_ros2/install/ur5_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur5_controller/environment/library_path.sh"
