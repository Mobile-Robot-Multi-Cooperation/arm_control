 ...
 */
class ARMTargetTrajectoriesInteractiveMarker final {
 public:
   ...
   */
  ARMTargetTrajectoriesInteractiveMarker(
 ...
 private:
  ...
  void armProcessFeedback(
      const visualization_msgs::msg::InteractiveMarkerFeedback::ConstSharedPtr&
          feedback);

  rclcpp::Node::SharedPtr node_;
  interactive_markers::MenuHandler arm_menuHandler_;
  interactive_markers::InteractiveMarkerServer arm_server_;
