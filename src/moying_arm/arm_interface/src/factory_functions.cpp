...
// 获取构建运动学的器人的维度
ARMModuleInfo createARMModuleInfo(const ocs2::PinocchioInterface& interface, const std::string& baseFrame, const std::string& aeFrame)
{
  ...
  info.eeFrame = aeFrame;
  std::cerr << "\n #### eaFrame:" << info.eeFrame << std::endl;
