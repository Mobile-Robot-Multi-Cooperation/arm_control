...
#include "arm_controller/arm_controller_parameters.hpp"
...
{
public:
  ARM_CONTROLLER__VISIBILITY_PUBLIC
  ARMController();
...
protected:
  std::shared_ptr<arm_controller::ParamListener> param_listener_;
  arm_controller::Params params_;
...
private:
  ...
  ARM_CONTROLLER__VISIBILITY_LOCAL
  ...
  std::shared_ptr<arm_interface::ARMInterface> armInterface_;
  std::shared_ptr<ocs2::MRT_ROS_Interface> mrtRosInterface_;
  std::shared_ptr<ocs2::MPC_ROS_Interface> mpcRosInterface_;
  std::shared_ptr<arm_interface::ARMJoyTargetTrajectories> targetPoseCommandInterface_;
...
#endif  // ARM_CONTROLLER__MMCO_CONTROLLER_HPP_
